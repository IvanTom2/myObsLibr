Отладочный режим необходим для отлавливания функций, которые работают больше 100 мс. Также он отлавливает выражения, где не были поставлены `await` - объекты не ожидаются.  
