Двусвязный список отличается от [[Односвязный список Singly List Node]] тем, что каждый узел имеет дополнительный указатель на предыдущий узел (либо на ничего). 
