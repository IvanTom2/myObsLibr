...
Here you should choose dirs for database/statis/media
Here you should rewrite DEBUG = FALSE
Here you should add ALLOWED_HOSTS = ['host']

Step 4. In basedir execute collectstatic and etc.
...
Language: [[Python]]
Key-words:  [[Django py]]
Question query?: Django разворачиваем на сервере nginx gunicorn socket